...
const std::unordered_map<std::string, KeyOps>& keyOps() {
    static const std::unordered_map<std::string, KeyOps> table = {
        ...
        {"call_merc_1_score",
         {makeGetter(&AppState::worker, &WorkerRuntimeState::call_merc_1_score),
          makeSetter(&AppState::worker, &WorkerRuntimeState::call_merc_1_score)}},
        {"call_merc_2_score",
         {makeGetter(&AppState::worker, &WorkerRuntimeState::call_merc_2_score),
          makeSetter(&AppState::worker, &WorkerRuntimeState::call_merc_2_score)}},
        {"call_merc_3_score",
         {makeGetter(&AppState::worker, &WorkerRuntimeState::call_merc_3_score),
          makeSetter(&AppState::worker, &WorkerRuntimeState::call_merc_3_score)}},
        {"call_merc_4_score",
         {makeGetter(&AppState::worker, &WorkerRuntimeState::call_merc_4_score),
          makeSetter(&AppState::worker, &WorkerRuntimeState::call_merc_4_score)}},
        {"call_merc_loop_count",
         {makeGetter(&AppState::worker, &WorkerRuntimeState::call_merc_loop_count),
          makeSetter(&AppState::worker, &WorkerRuntimeState::call_merc_loop_count)}},
        ...
        {"start_game_launcher_score",
         {makeGetter(&AppState::worker, &WorkerRuntimeState::start_game_launcher_score),
          makeSetter(&AppState::worker, &WorkerRuntimeState::start_game_launcher_score)}},
        {"start_game_intro_skip_score",
         {makeGetter(&AppState::worker, &WorkerRuntimeState::start_game_intro_skip_score),
          makeSetter(&AppState::worker, &WorkerRuntimeState::start_game_intro_skip_score)}},
        {"start_game_accept_score",
         {makeGetter(&AppState::worker, &WorkerRuntimeState::start_game_accept_score),
          makeSetter(&AppState::worker, &WorkerRuntimeState::start_game_accept_score)}},
        ...
        {"kill_counter_last_poll_detail",
         {makeGetter(&AppState::kill_counter, &KillCounterState::kill_counter_last_poll_detail),
          makeSetter(&AppState::kill_counter, &KillCounterState::kill_counter_last_poll_detail)}},
        {"kill_counter_session_baseline_n1",
         {makeGetter(&AppState::kill_counter, &KillCounterState::kill_counter_session_baseline_n1),
          makeSetter(&AppState::kill_counter, &KillCounterState::kill_counter_session_baseline_n1)}},
        {"kill_counter_session_last_n1",
         {makeGetter(&AppState::kill_counter, &KillCounterState::kill_counter_session_last_n1),
          makeSetter(&AppState::kill_counter, &KillCounterState::kill_counter_session_last_n1)}},
        {"kill_counter_loop_count",
         {makeGetter(&AppState::kill_counter, &KillCounterState::kill_counter_loop_count),
          makeSetter(&AppState::kill_counter, &KillCounterState::kill_counter_loop_count)}},
        {"flame_trigger_prev_press_timestamp",
         {makeGetter(&AppState::input, &InputState::flame_trigger_prev_press_timestamp),
          makeSetter(&AppState::input, &InputState::flame_trigger_prev_press_timestamp)}},
    };
    return table;
}
