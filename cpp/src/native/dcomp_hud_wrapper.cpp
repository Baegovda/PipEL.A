...
bool DCompHud::loadDll() {
    ...
    const std::filesystem::path candidates[] = {
        std::filesystem::path("native/cursor_hud_dcomp/build/cursor_hud_dcomp.dll"),
        std::filesystem::path("native/cursor_hud_dcomp/build/Release/cursor_hud_dcomp.dll"),
        std::filesystem::path("native/cursor_hud_dcomp/build/Debug/cursor_hud_dcomp.dll"),
    };
